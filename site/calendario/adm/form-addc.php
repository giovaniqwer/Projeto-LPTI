                    ...
                    <div class="col-md-12">
                      <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
	<form method="post" action="addc.php" name="formCadastro" enctype="multipart/form-data"  onsubmit="return validaForm()">
		<div class="col-md-6">
			<div class="alert alert-info">
				<div class="form-group" >
					<strong>CADASTRO</strong><br>
						<label></label>
							<input type="text" class="form-control" id="" name="txtNome" placeholder="Nome">
							<label></label>
