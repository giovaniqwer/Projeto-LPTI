...
<?php
	...
	$classificacao = isset($_POST['txtClassificacao']) ? $_POST['txtClassificacao'] : null;
	 ...
	 // insere no BD
	 $PDO = db_connect();
	 $sql ="INSERT INTO Evento(data, local, horario, palestrante, tema, descricao, Classificacao_Categoria_idCategoria) VALUES( :data, :local, :horario, :palestrante, :tema , :descricao , :classificacao)";
