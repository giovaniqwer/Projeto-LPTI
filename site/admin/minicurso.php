...
$sql = "SELECT idPost,idUsuario,dataPost, conteudoPost, Tag, Categoria_idCategoria FROM Post WHERE Categoria_idCategoria=1  ORDER BY idPost DESC";
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            ...
                                            <a class="active-menu" href="minicurso.php"><i class="fa fa-graduation-cap">&nbsp;Mini Cursos</i></a>
