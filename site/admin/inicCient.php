...
$sql = "SELECT idPost,idUsuario,dataPost, conteudoPost, Tag, Categoria_idCategoria FROM Post WHERE Categoria_idCategoria=7  ORDER BY idPost DESC";
                    ...
                    <nav class="navbar-default navbar-side" role="navigation">
                        <div class="sidebar-collapse">
                            <ul class="nav" id="main-menu">
                                ...
                                <li>
                                    <a class="active-menu" href="inicCient.php"><i class="fa fa-flask"></i>Iniciação Cientifica</a>
                                </li>
                                <li>
                                        ...
                                        <div class="panel panel-warning">
                                            <div class="panel-heading">
                                                ...
                                                <div class="alert-link">
                                                    Dono do Post&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a class="btn btn-warning" href="../Post/delete.php?id=<?php echo $post ['idPost'] ?>" onclick="return confirm('Deseja realmente remover este Post ?');" >Excluir Postagem</a>
