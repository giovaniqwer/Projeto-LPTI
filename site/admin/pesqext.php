...
$sql = "SELECT idPost,idUsuario,dataPost, conteudoPost, Tag, Categoria_idCategoria FROM Post WHERE Categoria_idCategoria=6  ORDER BY idPost DESC";
                                        ...
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                ...
                                                <div class="alert-link">
                                                    Dono do Post&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a class="btn btn-info" href="../Post/delete.php?id=<?php echo $post ['idPost'] ?>" onclick="return confirm('Deseja realmente remover este Post ?');" >Excluir Postagem</a>
                                                </div>
