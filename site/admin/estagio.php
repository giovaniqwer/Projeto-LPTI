...
$sql = "SELECT idPost,idUsuario,dataPost, conteudoPost, Tag, Categoria_idCategoria FROM Post WHERE Categoria_idCategoria=4 ORDER BY idPost DESC";
                    ...
                    <nav class="navbar-default navbar-side" role="navigation">
                        <div class="sidebar-collapse">
                            <ul class="nav" id="main-menu">
                                ...
                                <li>
                                    <a class="active-menu" href="estagio.php"><i class="fa fa-briefcase "></i>Estágio </a>
                                </li>
                                <li>
                                        ...
                                        <div class="panel panel-danger">
                                            <div class="panel-heading">
                                                ...
                                                <div class="alert-link">
                                                    Dono do Post&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a class="btn btn-danger" href="../Post/delete.php?id=<?php echo $post ['idPost'] ?>" onclick="return confirm('Deseja realmente remover este Post ?');" >Excluir Postagem</a>
                                                </div>
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                <div class="list-group">
                                                    ...
                                                    <a href="#" class="list-group-item">
                                                        <i class="fa fa-plus fa-fw"></i>Tag #01
                                                        <span class="pull-right text-muted small"><em></em>
                                                        </span>
                                                    </a>
                                                </div>
