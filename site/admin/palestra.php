					...
					<nav class="navbar-default navbar-side" role="navigation">
						<div class="sidebar-collapse">
							<ul class="nav" id="main-menu">
								<li>
									<a href="admin.phpphp"><i class="fa fa-dashboard "></i>Principal<br></a>
								</li>
								<li>
									...
									<ul class="nav nav-second-level">
										...
										<li>
											<a class="active-menu" href="palestra.html"><i class="fa fa-bell ">&nbsp;Palestras</i></a>
										</li>
										<li>
								...
								<div class="panel panel-info">
									...
									<div class="panel-body">
										<form role="form">
											...
											<div class="btn-group">
												<button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Categoria<span class="caret"></span></button>
												<ul class="dropdown-menu">
													<li><a href="#">Mini Curso</a></li>
													...
													<li><a href="#">Iniciacao Cientifica</a></li>
												...
												<div class="input-group">
													<input type="text" class="form-control" placeholder="Adicionar Tag" />
												</div>
											</div>


											<button type="button" id="post" class="btn btn-info">Postar</button>
											<br>
											<br>
