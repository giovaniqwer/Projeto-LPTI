...
$sql = "SELECT idContato, nomeContato, emailContato, comentarioContato, data FROM contatos ORDER BY idContato DESC";
                        ...
                        <div id="page-inner">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br />
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4" id="largura" style="width: 100%;">
                                                ...
                                                <?php while ($contato = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                                                    <div class="panel-body" style="padding: 0px;">
                                                        <div class="chat-widget-main">
                                                            ...
                                                            <?php echo $contato ['emailContato'] ?><br>
